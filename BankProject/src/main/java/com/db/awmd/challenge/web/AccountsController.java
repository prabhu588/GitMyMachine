...
public class AccountsController {
  ...
  public ResponseEntity<Object> transferMoney(@RequestBody @Valid AccountTransfer account) {
    ...
    try {
    this.accountsService.transferAmount(account);
    this.emailNotificationService.notifyAboutTransfer( getAccount(account.getSenderAccountId()), "Amount"+account.getAmount()+ "debitted successfully");
    this.emailNotificationService.notifyAboutTransfer( getAccount(account.getReciverAccountId()), "Amount" +account.getAmount()+"Credited succsfully successfully");
